...
Shader "BloodShader"
{
	Properties
	{
		...
		[Toggle(_USEVERTEXA_EROSION_ON)] _UseVertexA_Erosion("UseVertex.A_Erosion", Float) = 0
	...
	SubShader
	{
		...
		#pragma target 3.0
		#pragma shader_feature_local _USEVERTEXA_EROSION_ON
		struct Input
		{
			float2 uv_texcoord;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			#ifdef _USEVERTEXA_EROSION_ON
				float staticSwitch35 = ( 1.0 - i.vertexColor.a );
			#else
				float staticSwitch35 = _Erosion_Val;
			#endif
			float smoothstepResult28 = smoothstep( _Min , _Max , saturate( ( tex2D( _ErosionTex, ( uv0_ErosionTex + temp_output_23_0 ) ).r - (-1.0 + (staticSwitch35 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) ) ));
...
/*ASEBEGIN
Version=17800
2124;189;1522;674;1623.6;-434.1965;1.083363;True;False
...
Node;AmplifyShaderEditor.VertexColorNode;34;-1162.088,944.4603;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;7;-1281.964,781.3701;Inherit;False;Property;_Erosion_Val;Erosion_Val;6;0;Create;True;0;0;False;0;0;0.92;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;36;-880.4133,981.2946;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;35;-820.8283,830.7072;Inherit;False;Property;_UseVertexA_Erosion;UseVertex.A_Erosion;13;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;5;-830.1519,571.5611;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;-1;False;4;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=DA29B800E799D0D6A815C2916D1B7BC2D32FF89D